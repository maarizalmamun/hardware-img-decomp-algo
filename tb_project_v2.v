...
//// for milestone 2
`define INPUT_FILE_NAME "cat.sram_d2"
...
begin
	...
	//i=0; i<76800; i=i+1
	for (i=0; i<76800; i=i+1) begin //M1: i=146944; i<262144; i=i+1
...
always @ (posedge Clock_50) begin
	if (uut.SRAM_we_n == 1'b0) begin	//signal names within project (instantiated as uut) should match here, assuming names from experiment4a
		...
		if (uut.SRAM_address < 146944 && uut.SRAM_address > 76799) begin //uut.SRAM_address < 146944 && 
